...
instance.interceptors.request.use(
    (config) => {
        ...
        console.log("interceptor: ", config,"======================================== end request interceptor =============================");
        return config;
    },
    (error) => {
...
instance.interceptors.response.use(
    (response) => {
        console.log(" from res inter: ", response.status,"headers: ", response.headers, "data: ",response.data,"=====================================end res interceptor ===============================");
        return response;
    },
    (error) => {
